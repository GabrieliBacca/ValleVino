...
var getUsers = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, db_server_1.db.user.findMany({
                    select: {
                        id: true,
                        name: true,
                        email: true,
            ...
            case 1:
                ...
                return [2 /*return*/, users.map(function (user) { return (__assign(__assign({}, user), { telephone: user.telephone.toString() })); })];
        }
    });
}); };
...
var getUserById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, db_server_1.db.user.findUnique({
                    where: {
                        id: id
                    },
                    select: {
            ...
            case 1:
                user = _a.sent();
                if (user) {
                    return [2 /*return*/, __assign(__assign({}, user), { telephone: user.telephone.toString() })];
                }
                else {
...
var createUser = function (user) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        ...
        return [2 /*return*/, db_server_1.db.user.create({
                data: user,
                select: {
                    id: true,
                    name: true,
...
var updateUser = function (user, id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        // Convertendo a string de data para um objeto Date
        user.birthday = new Date(user.birthday);
        return [2 /*return*/, db_server_1.db.user.update({
                where: {
                    id: id
                },
                data: user,
...
var deleteUserById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, db_server_1.db.user.delete({
                where: {
                    id: id
                }
            })];
